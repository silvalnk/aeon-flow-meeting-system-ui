...
export type LoginResponseEither = Either<AppError, LoginResponse>;
...
export type ListReservationsResponse = Either<AppError, ReservationEntity[]>;
...
export type GetReservationResponse = Either<AppError, ReservationEntity>;
...
export type CreateReservationResponse = Either<AppError, ReservationEntity>;
...
export type UpdateReservationResponse = Either<AppError, ReservationEntity>;
...
export type CancelReservationResponse = Either<AppError, void>;
