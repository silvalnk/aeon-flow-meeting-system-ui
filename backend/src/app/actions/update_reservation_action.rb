...
require_relative '../../lib/reservations/application/use_cases/update_reservation_use_case'
require_relative '../serializers/reservation_serializer'

module App
  module Actions
    class UpdateReservationAction < SharedDomain::Web::Action
      def call(params = {})
        input_dto = {
        ...
        Reservations::Application::UseCases::UpdateReservationUseCase.new.call(input_dto) do |m|
